package com.ezhan1me.app.ui.navigation.settings
...
import com.ezhan1me.app.BuildConfig
import com.ezhan1me.app.HanimeConstants
import com.ezhan1me.app.HA1_GITHUB_FORUM_URL
import com.ezhan1me.app.HA1_GITHUB_ISSUE_URL
import com.ezhan1me.app.HanimeApplication
import com.ezhan1me.app.Preferences
import com.ezhan1me.app.R
import com.ezhan1me.app.logic.BackupManager
import com.ezhan1me.app.logic.state.WebsiteState
import com.ezhan1me.app.ui.activity.MainActivity
import com.ezhan1me.app.ui.component.ConfirmDialog
import com.ezhan1me.app.ui.screen.settings.HomeSettingsScreen
import com.ezhan1me.app.ui.screen.settings.dialog.LicenseDialog
import com.ezhan1me.app.ui.screen.settings.model.HomeSettingsUiState
import com.ezhan1me.app.ui.screen.home.homepage.defaultHomeCategoryPreferenceItems
import com.ezhan1me.app.ui.screen.home.homepage.hiddenHomeCategoryKeys
import com.ezhan1me.app.ui.screen.home.homepage.homeCategoryOrder
import com.ezhan1me.app.ui.screen.home.homepage.saveHomeCategoryPreferences
import com.ezhan1me.app.ui.theme.ThemeColorPreset
import com.ezhan1me.app.ui.viewmodel.AppViewModel
import com.ezhan1me.app.util.ThemeUtils
import com.ezhan1me.app.util.showToast
import com.ezhan1me.libs.ActivityManager
import com.ezhan1me.libs.utils.applicationContext
import com.ezhan1me.libs.utils.browse
import com.ezhan1me.libs.utils.folderSize
...
fun HomeSettingsRouteScreen(
    ...
    val launcherItems = remember(context) {
        listOf(
            LauncherItem(
                ...
                alias = "com.ezhan1me.app.LauncherAliasDefault",
            ),
            LauncherItem(
                name = fakeNameCalc,
                iconRes = R.drawable.ic_launcher_calc,
                alias = "com.ezhan1me.app.LauncherFakeCalc",
            ),
            LauncherItem(
                name = fakeNameCornhub,
                iconRes = R.drawable.ic_launcher_cornhub,
                alias = "com.ezhan1me.app.LauncherFakeCornhub",
            ),
            LauncherItem(
                name = fakeNameXXT,
                iconRes = R.drawable.ic_launcher_xxt,
                alias = "com.ezhan1me.app.LauncherFakeXxt",
            ),
        )
    }
    ...
    HomeSettingsScreen(
        ...
        onExportBackup = {
            exportLauncher.launch("EZ-Han1me-backup-${System.currentTimeMillis()}.json")
        },
        onImportBackup = {
