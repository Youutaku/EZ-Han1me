...
import com.ezhan1me.app.logic.model.UserAccountActionEvent
    ...
    fun loadAccount(forceReload: Boolean = false) {
        ...
        if (userId.isBlank()) {
            _accountState.value = WebsiteState.Error(
                IllegalStateException(application.getString(com.ezhan1me.app.R.string.not_logged_in_currently))
            )
            return
        }
