...
import com.ezhan1me.app.getHanimeVideoLink
import com.ezhan1me.app.logic.DatabaseRepo
import com.ezhan1me.app.logic.dao.CheckInRecordDatabase
import com.ezhan1me.app.logic.entity.HKeyframeEntity
import com.ezhan1me.app.logic.entity.WatchHistoryEntity
...
import com.ezhan1me.app.PermissionRequester
import com.ezhan1me.app.ui.navigation.main.VideoRoute
import com.ezhan1me.app.ui.view.video.ExoMediaKernel
import com.ezhan1me.app.ui.view.video.HJzvdStd
import com.ezhan1me.app.ui.view.video.HMediaKernel
import com.ezhan1me.app.ui.view.video.HanimeDataSource
import com.ezhan1me.app.ui.view.video.VideoPlayerAppBarBehavior
import com.ezhan1me.app.ui.viewmodel.CommentViewModel
import com.ezhan1me.app.ui.viewmodel.VideoViewModel
import com.ezhan1me.app.util.checkBadGuy
import com.ezhan1me.app.util.loadAssetAs
import com.ezhan1me.libs.utils.OrientationManager
import com.ezhan1me.libs.utils.browse
import com.ezhan1me.libs.utils.copyToClipboard
import com.ezhan1me.libs.utils.dp
import com.ezhan1me.libs.utils.shareText
import com.ezhan1me.libs.utils.showShortToast
import com.ezhan1me.libs.utils.startActivity
...
fun VideoRouteHostScreen(
    ...
    val genres = remember(Preferences.baseUrl) {
        loadAssetAs<List<SearchOption>>(
            if (Preferences.baseUrl == com.ezhan1me.app.HanimeConstants.HANIME_URL[3]) {
