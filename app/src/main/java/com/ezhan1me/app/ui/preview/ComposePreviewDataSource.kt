...
package com.ezhan1me.app.ui.preview
...
import com.ezhan1me.app.logic.model.Announcement
import com.ezhan1me.app.logic.model.DownloadHeaderNode
import com.ezhan1me.app.logic.model.DownloadItemNode
import com.ezhan1me.app.logic.model.GetchuPreview
import com.ezhan1me.app.logic.model.GetchuPreviewDetail
...
import com.ezhan1me.app.ui.screen.home.homepage.HomeCategory
...
val fakeDownloadedVideos = fakeHomePageVideos.take(3).mapIndexed { index, item ->
    VideoWithCategories(
        video = HanimeDownloadEntity(
            ...
            state = com.ezhan1me.app.logic.state.DownloadState.Finished,
            id = index + 1,
        ),
...
val fakeVideoIntroduction = HanimeVideo(
    ...
    views = "137.6万次",
    videoUrls = com.ezhan1me.app.HanimeResolution().apply {
